...
$pal=$_POST['Palabra'];
if($pal){
    $resp = mysqli_query($link, "select * from buscador where canciones LIKE '%".$pal."%'") or die("Problemas en el select:" . mysqli_error($conexion));
    if(mysqli_num_rows($resp) == "0") {
     echo "No hay resultados respecto a la palabra que busca.";
            ...
            echo "<center><strong>RESULTADOS DE BUSQUEDA</strong></center><br>";
              ...
              <br>
        <?php                 }            }
    }else{echo "<form name='FormBuscador' method='post' action=''><input name='Palabra' type='text' 
